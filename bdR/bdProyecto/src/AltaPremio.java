 ...
 */
public class AltaPremio extends javax.swing.JDialog {

    /**
     * Creates new form AltaPremio
     */
    public AltaPremio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, 80, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AltaPremio dialog = new AltaPremio(new javax.swing.JFrame(), true);
